...
**Honest coverage**: only Legilux's *consolidated* collection (dense from 2017,
sparse before, with historical and future-dated snapshots). Acts the publisher
never places in that collection are not here; current counts and gaps are reported on
[law.soufien.lu/coverage](https://law.soufien.lu/coverage). Text: CC-BY-4.0 (Legilux, Ministère
